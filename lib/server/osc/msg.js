...
function flattenPairs(pairs) {
    if (lodash_1.default.isPlainObject(pairs)) {
        return lodash_1.default.flatten(lodash_1.default.toPairs(pairs));
    }
    if (lodash_1.default.isArray(pairs)) {
        return lodash_1.default.flatten(pairs);
    }
    // unreachable
...
var AddActions;
(function (AddActions) {
    AddActions[AddActions["HEAD"] = 0] = "HEAD";
    AddActions[AddActions["TAIL"] = 1] = "TAIL";
    AddActions[AddActions["BEFORE"] = 2] = "BEFORE";
    AddActions[AddActions["AFTER"] = 3] = "AFTER";
    AddActions[AddActions["REPLACE"] = 4] = "REPLACE";
})(AddActions = exports.AddActions || (exports.AddActions = {}));
/**
 * Tell server to exit
 *
 ...
 *
 */
function defRecv(buffer, completionMsg) {
    if (completionMsg === void 0) { completionMsg = null; }
    return {
...
/**
  ...
  * @return {Array} - OSC message
  */
function defLoad(path, completionMsg) {
    if (completionMsg === void 0) { completionMsg = null; }
    return {
 ...
 * @return {Array} - OSC message
 */
function defLoadDir(path, completionMsg) {
    if (completionMsg === void 0) { completionMsg = null; }
    return {
 ...
 * @return {Array} - OSC message
 */
function nodeSetn(nodeID, valueSets) {
    return ["/n_setn", nodeID].concat(flattenPairs(valueSets));
}
 ...
 * @return {Array} - OSC message
 */
function nodeFill(nodeID, triples) {
    if (triples === void 0) { triples = []; }
    return ["/n_fill", nodeID].concat(flattenPairs(triples));
}
...
/**
  ...
  */
function nodeMapn(nodeID, triples) {
    if (triples === void 0) { triples = []; }
    return ["/n_mapn", nodeID].concat(flattenPairs(triples));
}
 ...
 */
function nodeMapAudion(nodeID, triples) {
    if (triples === void 0) { triples = []; }
    return ["/n_mapan", nodeID].concat(flattenPairs(triples));
}
...
/**
  ...
  * @return OSC message
  */
function synthNew(defName, nodeID, addAction, targetID, args) {
    if (nodeID === void 0) { nodeID = -1; }
    if (addAction === void 0) { addAction = AddActions.TAIL; }
...
/**
  ...
  * @return {Array} - OSC message
  */
function groupNew(nodeID, addAction, targetID) {
    if (addAction === void 0) { addAction = AddActions.HEAD; }
    if (targetID === void 0) { targetID = 0; }
    return ["/g_new", nodeID, lodash_1.default.isUndefined(addAction) ? AddActions.HEAD : addAction, targetID || 0];
}
...
/**
  ...
  * @return {Array} - OSC message
  */
function parallelGroupNew(groupID, addAction, targetID) {
    if (addAction === void 0) { addAction = AddActions.HEAD; }
    if (targetID === void 0) { targetID = 0; }
...
/**
  ...
  *
  */
function groupDumpTree(groupID, dumpControlValues) {
    if (dumpControlValues === void 0) { dumpControlValues = 0; }
...
/**
  ...
  * @return {Array} - OSC message
  */
function groupQueryTree(groupID, dumpControlValues) {
    if (dumpControlValues === void 0) { dumpControlValues = 0; }
    return {
...
/**
  ...
  * @return {Array} - OSC message
  */
function ugenCmd(nodeID, uGenIndex, command, args) {
    if (args === void 0) { args = []; }
...
/**
  ...
  * @return {Array} - OSC message
  */
function bufferAlloc(bufferID, numFrames, numChannels, completionMsg) {
    if (completionMsg === void 0) { completionMsg = null; }
    return {
...
/**
  ...
  * @return {Array} - OSC message
  */
function bufferAllocRead(bufferID, path, startFrame, numFramesToRead, completionMsg) {
...
/**
  ...
  * @return {Array} - OSC message
  */
function bufferAllocReadChannel(bufferID, path, startFrame, numFramesToRead, channels, completionMsg) {
    if (completionMsg === void 0) { completionMsg = null; }
    var call = ["/b_allocReadChannel", bufferID, path, startFrame, numFramesToRead].concat(channels);
    if (completionMsg) {
...
/**
  ...
  * @return {Array} - OSC message
  */
function bufferRead(bufferID, path, startFrame, numFramesToRead, startFrameInBuffer, leaveFileOpen, completionMsg) {
    if (startFrame === void 0) { startFrame = 0; }
    if (numFramesToRead === void 0) { numFramesToRead = -1; }
    if (startFrameInBuffer === void 0) { startFrameInBuffer = 0; }
    if (leaveFileOpen === void 0) { leaveFileOpen = 0; }
    if (completionMsg === void 0) { completionMsg = null; }
    return {
...
/**
  ...
  * @return {Array} - OSC message
  */
function bufferReadChannel(bufferID, path, startFrame, numFramesToRead, startFrameInBuffer, leaveFileOpen, channels, completionMsg) {
    if (startFrame === void 0) { startFrame = 0; }
    if (numFramesToRead === void 0) { numFramesToRead = -1; }
    if (startFrameInBuffer === void 0) { startFrameInBuffer = 0; }
    if (leaveFileOpen === void 0) { leaveFileOpen = 0; }
...
/**
  ...
  * @return {Array} - OSC message
  */
function bufferWrite(bufferID, path, headerFormat, sampleFormat, numFramesToWrite, startFrameInBuffer, leaveFileOpen, completionMsg) {
    if (headerFormat === void 0) { headerFormat = "aiff"; }
    if (sampleFormat === void 0) { sampleFormat = "float"; }
    if (numFramesToWrite === void 0) { numFramesToWrite = -1; }
    if (startFrameInBuffer === void 0) { startFrameInBuffer = 0; }
    if (leaveFileOpen === void 0) { leaveFileOpen = 0; }
    if (completionMsg === void 0) { completionMsg = null; }
    return {
 ...
 * @return {Array} - OSC message
 */
function bufferFree(bufferID, completionMsg) {
    if (completionMsg === void 0) { completionMsg = null; }
    return {
...
/**
  ...
  * @return {Array} - OSC message
  */
function bufferZero(bufferID, completionMsg) {
    if (completionMsg === void 0) { completionMsg = null; }
    return {
...
function bufferSet(bufferID, pairs) {
    return ["/b_set", bufferID].concat(flattenPairs(pairs));
}
...
/**
  ...
  * @return {Array} - OSC message
  */
function bufferSetn(bufferID, startFrame, values) {
...
/**
  ...
  * @return {Array} - OSC message
  */
function bufferGen(bufferID, command, args) {
    if (args === void 0) { args = []; }
    return {
...
function controlBusSet(pairs) {
    return ["/c_set"].concat(flattenPairs(pairs));
}
...
/**
  ...
  * @return {Array} - OSC message
  */
function controlBusSetn(triples) {
    if (triples === void 0) { triples = []; }
    return ["/c_setn"].concat(flattenPairs(triples));
}
 ...
 * @return {Array} - OSC message
 */
function controlBusFill(triples) {
    if (triples === void 0) { triples = []; }
    return ["/c_fill"].concat(flattenPairs(triples));
}
