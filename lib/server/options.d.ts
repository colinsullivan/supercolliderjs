 ...
 */
export declare type ServerOptions = ScsynthArgs & ServerSettings;
export declare type ServerArgs = Partial<ScsynthArgs> & Partial<ServerSettings>;
export declare const defaults: ServerOptions;
export {};
